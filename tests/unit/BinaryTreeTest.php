...
final class BinaryTreeTest extends TestCase
{
    ...
    public function testShouldPOstorderTraverseASingleNodeBinaryTree()
    {
        $this->tree->insert(1);
        $expectedOrder = [1];

        $this->assertTraverse('postOrder', $expectedOrder);
    }

    public function testPostOrderTraverseABinaryTreeWithRootAndRightNode()
    {
        $this->tree->insert(1);
        $this->tree->insert(2);
        $expectedOrder = [2, 1];
    ...
    public function testPostorderTraverseABinaryTreeWithRootAndLeftNode()
    {
        $this->tree->insert(2);
        $this->tree->insert(1);
        $expectedOrder = [2, 1];
    ...
    public function testPostorderTraverseABinaryTreeWithSubtrees()
    {
        $this->tree->insert(4);
        $this->tree->insert(6);
        $this->tree->insert(5);
